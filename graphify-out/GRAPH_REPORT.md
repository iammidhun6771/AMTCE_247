# Graph Report - D:\Youtube Automation\AMTCE-v7.1  (2026-06-25)

## Corpus Check
- 485 files · ~1,210,310 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6385 nodes · 20204 edges · 642 communities detected
- Extraction: 33% EXTRACTED · 67% INFERRED · 0% AMBIGUOUS · INFERRED: 13540 edges (avg confidence: 0.56)
...
- `GeminiGovernor` --uses--> `Evaluates the user's task and decides where to route it.     Uses GeminiGovernor`  [INFERRED]
  D:\Youtube Automation\AMTCE-v7.1\Intelligence_Modules\gemini_governor.py → D:\Autonomous Multimedia Transformation & Compilation Engine (AMTCE)\Swarm_Orchestration\main_controller.py
- `GeminiGovernor` --uses--> `Handles 'Antigravity' (Reasoning/Coding) tasks.     Uses RouterOrchestra to rota`  [INFERRED]
  D:\Youtube Automation\AMTCE-v7.1\Intelligence_Modules\gemini_governor.py → D:\Autonomous Multimedia Transformation & Compilation Engine (AMTCE)\Swarm_Orchestration\main_controller.py
- `GeminiGovernor` --uses--> `Handles 'CrewAI' (Swarm) tasks.`  [INFERRED]
  D:\Youtube Automation\AMTCE-v7.1\Intelligence_Modules\gemini_governor.py → D:\Autonomous Multimedia Transformation & Compilation Engine (AMTCE)\Swarm_Orchestration\main_controller.py
- `GeminiGovernor` --uses--> `Sovereign Interrupt: Waits for USER approval before allowing Swarm execution.`  [INFERRED]
  D:\Youtube Automation\AMTCE-v7.1\Intelligence_Modules\gemini_governor.py → D:\Autonomous Multimedia Transformation & Compilation Engine (AMTCE)\Swarm_Orchestration\main_controller.py
...
Cohesion: 0.0
Nodes (584): run_daily_cycle(), adapt_prompt_with_emotion(), get_emotion_adjustments(), FrameProducer, HeavyEditor, Cleanly disable all enhancement features., Detects environment and auto-installs missing acceleration libraries., Check if model exists, if not download it (Sanity Wrapper). (+576 more)
...
Cohesion: 0.01
Nodes (333): AdaptiveBrain, calculate_std_dev(), clamp(), PsychometricEngine, Self-Healing Adaptive Intelligence Engine v3 ----------------------------------, The Core Logic for Protection., Returns restrictive parameters based on level., Calculates entropy. If low, suggests a neglected trigger. (+325 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (324): apply_edit_timeline(), get_video_duration(), match_transitions_to_gaps(), ceie/applicator.py ------------------ Master edit applicator for CEIE. Executes, Gets total duration via ffprobe., Matches planned transitions to the gaps between segment cuts.     For N segments, Executes the full edit pipeline on video_path according to timeline.     Saves f, detect_beats() (+316 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (249): start_publish_scheduler(), _auto_publish_clip(), _batch_label(), start_scheduler(), main(), _compress(), _contains_blacklisted(), get_fallback() (+241 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (176): actress_scheduler.py — AMTCE Daily Auto-Discovery Engine ======================, Returns (seconds_to_wait, label) for the next scheduled slot., Dispatcher for harvest cycles.     PAPARAZZI_MODE=yes in Credentials/.env -> ru, Classic actress-account mode (legacy). Reads from actress_accounts.json., Returns (next_run_datetime, is_missed).     is_missed=True means a slot passed, Returns the next scheduled slot that is STRICTLY in the future (>= 1 min)., Classic actress-account mode (legacy). Reads from actress_accounts.json., Launches the actress scheduler as a background daemon thread.     Safe to call (+168 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (139): EffectAssigner, Effect assignment module (extracted from SmartSceneEditor)., Adds effect hints to each segment WITHOUT overwriting values already         se, Assigns transitions, zooms, and visual cues to timeline segments., MomentSelector, Moment selector module (extracted from SmartSceneEditor)., Sort candidates by importance/score descending., Ranks candidate moments for downstream timeline building. (+131 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (167): LinkOptimizer, Periodically decay weights to prevent stagnation., Selects a link using Exploration (10%) vs Exploitation (90%).         Prioritiz, Loads link performance state from JSON., Saves current state to JSON., Registers a click (impression/usage) for a link., Registers a conversion (if feedback loop exists)., Initializes a new link in the state. (+159 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (138): get_all_active_accounts(), get_primary_accounts(), get_secondary_accounts(), _get_social_folders(), get_target_folder(), is_account_mode_enabled(), _load_config(), actress_config.py — AMTCE Actress Account Router =============================== (+130 more)
...
Cohesion: 0.02
Nodes (135): answer_user_query_ai(), clean_html_for_telegram(), extract_base_actress_name(), generate_bargain_response(), generate_tempting_hook(), get_clean_actress_name(), ai_helper.py ──────────── Centralized AI module utilizing Gemini, Groq, and Mist, Answers customer inquiries using Gemini, Groq, or Mistral, responding as the dyn (+127 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (118): extract_auction_item(), compute_anchor(), _is_skin_or_hair(), Returns (anchor_x, anchor_y, side, debug_info).     - side: "left" or "right" ch, Uses Gemini to generate a dual-CTA psychological hook specifically for the Teleg, analyze_video(), ForensicVideoAnalyzer, get_analyzer() (+110 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (105): cosine(), Deterministic hash across runs., stable_hash(), choose(), compute(), DynamicTrimCalculator, EnergyProgressionGuard, Visual_Refinement_Modules/rhythm_quality_guard.py ----------------------------- (+97 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (69): build_arc_caption_spec(), build_caption_drawtext_filter(), build_drawtext_filters(), escape_drawtext(), font_size_for_line(), get_font_path(), is_emphasis_line(), _line_char_limits() (+61 more)
...
Cohesion: 0.04
Nodes (83): check_models_presence(), install_missing_dependencies(), Checks watermark_requirements.txt and installs any missing packages., Ensures the 'models' directory and files are present.     If missing, provides, Main entry point for setup., run_setup(), FaceProtector, HybridWatermarkDetector (+75 more)
...
Cohesion: 0.04
Nodes (42): FashionScout, _fuzzy_match_product(), _get_affiliate_link(), get_fallback_payload(), fashion_scout.py ================ Hierarchical Fashion Intelligence Pipeline, Hard schema-validation gate. Rejects any result that would produce a bad     Am, Independent query quality scorer. Returns 0.0–1.0.      Scoring breakdown (eac, Evaluates product title (wear_name) for retail-grade (industry-standard) naming. (+34 more)
...
Cohesion: 0.06
Nodes (36): Scans the directory for duplicate audio files based on content hash.     Keeps, scan_and_clean_duplicates(), AudioPoolManager, _is_pipeline_artifact(), Helper to get file metadata accounting for schema version., Helper to set file metadata accounting for schema version., [FIX] Move any loose .mp3/.wav files sitting in Original_audio/ root into, Scan active/ folder and ensure all files are registered in pool_metadata.json. (+28 more)
...
Cohesion: 0.31
Nodes (8): _generate_pkce_pair(), _load_env(), main(), auth_tiktok.py — One-time TikTok OAuth 2.0 Authorization Helper (PKCE) =========, Parse key=value pairs from Credentials/.env., Resolve where to save the token store for this niche., Generate a PKCE code_verifier and code_challenge (S256 method).     TikTok requi, _token_file_path()
...
## Knowledge Gaps
- **1973 isolated node(s):** `review_server.py — AMTCE Live Editorial Interruption Server ====================`, `Background thread: tail the AMTCE log file and push lines to SSE queue.`, `Serve the Studio UI HTML.`, `Return the full review queue with clip metadata.`, `Return AMTCE system health and queue stats.` (+1968 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 63`** (2 nodes): `call_cerebras()`, `cerebras_connector.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (2 nodes): `generate_ast_graph()`, `ast_generator.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (2 nodes): `dependency_graph.py`, `generate_dependency_graph()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (2 nodes): `system_prompts.py`, `System Prompts for Bot Intelligence ----------------------------------- Centra`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (2 nodes): `runtime_flags.py`, `config/runtime_flags.py ────────────────────────────────────────────────────────`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (2 nodes): `Legacy shim for compiler module.`, `compiler.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (2 nodes): `test_cag.py`, `mock_generate_metadata()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (2 nodes): `test_gemini_raw.py`, `test_raw_gemini()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (2 nodes): `inject_scheduler.py`, `inject_scheduler.py — Injects run_paparazzi_cycle + dispatcher into actress_sche`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (2 nodes): `rebuild_dataset.py`, `rebuild()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (2 nodes): `run_bot.py`, `run_bot.py ────────── Launches the sales bot. This is the script you keep runnin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (2 nodes): `test_creative_director.py`, `generate_mock_profile()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (1 nodes): `check_yaml.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 80`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (1 nodes): `Multi-clip timeline rendering shim.         Restores the 'rhythm-sync' compilat`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 82`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (1 nodes): `Convenience constructor: builds a VideoLog entry from EditorBrainV3 output.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (1 nodes): `boot_test.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (1 nodes): `check_keys.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (1 nodes): `check_vp.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (1 nodes): `data_resolver.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (1 nodes): `diag_full.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (1 nodes): `discover_classes.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (1 nodes): `fix_engine_deps.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (1 nodes): `fix_rhythm_deps.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (1 nodes): `fix_rtb.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (1 nodes): `inspect_apis.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 95`** (1 nodes): `inspect_compilers.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (1 nodes): `sig_check.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 97`** (1 nodes): `strip_editor.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 98`** (1 nodes): `test_deps.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 99`** (1 nodes): `test_shot_detector.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 100`** (1 nodes): `test_sigs.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 101`** (1 nodes): `test_tracker.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 102`** (1 nodes): `Quick log for non-API events (like cache hits)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (1 nodes): `Compute a segment diversity score [0..1]. True = diverse enough.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (1 nodes): `Populate StepTracer from FeatureAuditor status string.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (1 nodes): `Install all patches. Returns count of successfully patched functions.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 107`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 108`** (1 nodes): `Attempts to import a standard module dynamically.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (1 nodes): `Detects hardware capabilities WITHOUT importing torch/tensorflow if possible ini`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (1 nodes): `Calculates Expected Value.         Confidence: 0.0 to 1.0 (Probability of Succe`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (1 nodes): `Gatekeeper Function. Returns True if EV > threshold.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (1 nodes): `Computes STATIC_SCORE based on trajectory data.         Returns: 0.0 to 1.0 (Hi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (1 nodes): `Computes strict byte-level hash.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (1 nodes): `Computes DCT-based Perceptual Hash (pHash) on the middle frame.         Robust`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (1 nodes): `Computes Hamming distance between two 64-bit hex hashes.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (1 nodes): `Checks for collisions in the index.         Returns:             (collision_ty`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 117`** (1 nodes): `Registers the content in the index.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 118`** (1 nodes): `Return the time of the highest expression_change in the early window.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 119`** (1 nodes): `Compares input vs output video quality.         Returns dict with deltas and PA`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (1 nodes): `Uses ffmpeg scene detection to estimate scene cuts.         Fail if < 2 "scenes`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 121`** (1 nodes): `Checks if video is effectively static.         Returns: motion_score (0.0 - 1.0`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 122`** (1 nodes): `Complete check. Returns (is_safe: bool, reason: str)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (1 nodes): `Feature 1: Weighted Risk Probability Scoring.         Returns: risk_score (0-10`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 126`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (1 nodes): `orphan_check.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 128`** (1 nodes): `test_channel_router.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 129`** (1 nodes): `test_tracker.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 130`** (1 nodes): `verify_compute.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 131`** (1 nodes): `verify_dnn.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 132`** (1 nodes): `verify_integration.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 133`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 134`** (1 nodes): `verify_crew.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 135`** (1 nodes): `generate_test_graph.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 136`** (1 nodes): `Verify that a HIGH risk from the brain is NOT overwritten by the compiler.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 137`** (1 nodes): `Verify that UNKNOWN (Brain Offline) is reported as MEDIUM, not LOW.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 138`** (1 nodes): `test_onnx.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 139`** (1 nodes): `Verify that the render pipeline:         1. Uses hardware decode (-hwaccel auto)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 140`** (1 nodes): `Verify that if no zoom, speed ramps, or transitions exist, the graph         rem`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 141`** (1 nodes): `Should successfully upload, analyze and clean up the video.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 142`** (1 nodes): `Should attempt file cleanup even if model generation fails.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 148`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 149`** (1 nodes): `test.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 150`** (1 nodes): `test_import.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 151`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 152`** (1 nodes): `Strip NSFW emojis from any string before writing it into a YouTube comment.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 153`** (1 nodes): `Reads The_json/geo_analytics.json, maps country → language,         aggregates`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 154`** (1 nodes): `7 PM IST — Pick two reels, open the poll, post both videos, send ONE message.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 155`** (1 nodes): `9 PM IST — Settle and post ONE result message.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 156`** (1 nodes): `Resolves Meta credentials using a 3-tier priority chain:           1. Credentia`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 157`** (1 nodes): `Orchestrates uploads to enabled Meta platforms.          The ``niche`` paramet`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 158`** (1 nodes): `Uploads the local image to a temporary public host so the Instagram         Gra`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 159`** (1 nodes): `Smart person-aware Instagram ratio formatter (4:5 = 1080x1350).          Strat`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 160`** (1 nodes): `Uploads a standard Image Post to Instagram feed using the Graph API.         Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 161`** (1 nodes): `Cleans captions of UTF-16 surrogates that cause UnicodeEncodeError in httpx/UTF-`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 162`** (1 nodes): `Generic retry wrapper for HTTP requests using httpx.         Default timeout in`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 163`** (1 nodes): `Polls Instagram container status until FINISHED or ERROR.         Timeout defau`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 164`** (1 nodes): `Non-blocking lock with timeout to prevent bot hangs.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 165`** (1 nodes): `FOMO ESCALATION CASCADE (Upgraded A1)         Changes tone based on pot size to`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 166`** (1 nodes): `High-pressure FOMO alerts for the final 15 minutes.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 167`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 168`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 169`** (1 nodes): `list_models.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 170`** (1 nodes): `list_models_filtered.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 171`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 172`** (1 nodes): `Detects hardware capabilities WITHOUT importing torch/tensorflow if possible ini`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 173`** (1 nodes): `debug_orientation.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 174`** (1 nodes): `Strategy A: Erosion/Shrink.         Reduces the mask size to minimize the "blur`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 175`** (1 nodes): `Strategy B: Reduced Radius.         Calculates a safe radius for second-attempt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 176`** (1 nodes): `Singleton pattern so we only load the 500MB model into memory once.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 177`** (1 nodes): `Returns a list of tuples: (role_name, count)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 178`** (1 nodes): `Takes a role-assigned story_map and ensures climax score >= average build score.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 179`** (1 nodes): `Returns (pre_seconds, post_seconds) based on moment signals.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 180`** (1 nodes): `Use Gemini Vision to extract UTR + amount from a UPI payment screenshot.     Re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 470`** (1 nodes): `Return a synthetic snapshot for testing without API access.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 471`** (1 nodes): `Fetch views, avg view duration, likes.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 472`** (1 nodes): `Fetch audience retention curve.         Returns list of {"t": float, "pct": floa`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `GeminiCaptionGenerator` connect `Community 5` to `Community 2`, `Community 10`, `Community 12`, `Community 4`?**
